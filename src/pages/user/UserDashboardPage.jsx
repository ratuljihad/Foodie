      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            <Link
              to="/restaurants"
              className="rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-center font-medium text-slate-700 hover:bg-slate-100 transition-colors col-span-2"
            >
              Browse Restaurants
            </Link>
            <Link
